package com.example.microsoft.tgs_marker_putri_15421032;
...
public class Map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.invalidate();
        startMarker1.setIcon(getResources().getDrawable(R.drawable.icon8));
        ...
        map.invalidate();
        startMarker2.setIcon(getResources().getDrawable(R.drawable.icon7));
        ...
        map.invalidate();
        startMarker3.setIcon(getResources().getDrawable(R.drawable.icon4));
        ...
        map.invalidate();
        startMarker4.setIcon(getResources().getDrawable(R.drawable.icon6));
        startMarker4.setTitle("Mall Bumi Kedaton");

        GeoPoint startPoint5 = new GeoPoint(-5.460271,105.323363);
